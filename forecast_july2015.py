"""
╔══════════════════════════════════════════════════════════════════╗
║  Random Forest — July 2015 Rainfall Intensity FORECAST          ║
║  Train : 2010 – 2014  |  Test : July 2015                       ║
║  Target: Computed RI (DSD physics formula, same as mlModel.py)  ║
║  Data  : RD-80 Disdrometer | Kolkata | processed_data.csv       ║
╚══════════════════════════════════════════════════════════════════╝
"""
...
# CONFIG
# ─────────────────────────────────────────────────────────────────
DATA_FILE = "processed_data.csv"   # same CSV as repo
PLOT_DIR  = "plots"
